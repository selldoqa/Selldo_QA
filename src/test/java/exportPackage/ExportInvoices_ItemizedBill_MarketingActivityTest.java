...
public class ExportInvoices_ItemizedBill_MarketingActivityTest extends SetUp {

	final static Logger logger = Logger.getLogger(ExportInvoices_ItemizedBill_MarketingActivityTest.class);
	...
	public void exportInvoices_ItemizedBill_MarketingActivityTest() throws Exception {
		...
		test = extent.createTest("exportInvoices_ItemizedBill_MarketingActivityTest");
		setExtentTest(test);
		...
		getExtTest().log(Status.INFO, "Clicking on Export Invoices tab.......");
		exportPage.clickOnExportInvoicesTab();

		getExtTest().log(Status.INFO, "Selecting Invoice from dropdown.......");
		exportPage.selectInvoice("ADPL-23886097720170421 (01/01/2017-22/04/2017)");

		getExtTest().log(Status.INFO, "Selecting Marketing Activity from Type dropdown.......");
		...
		getExtTest().log(Status.INFO, "Selecting Export type as Itemised Bill(Marketing Activity).......");
		...
		String itemisedBill_MarketingActivity = driver.findElements(exportPage.exportLabel).get(0).getAttribute("innerHTML");
		System.out.println(itemisedBill_MarketingActivity);

		getExtTest().log(Status.INFO, "Validating that the latest export is made for Itemized Bill Marketings.......");
		Assert.assertEquals(itemisedBill_MarketingActivity, "Itemized Bill Marketings - Export 1", "Not matched");
