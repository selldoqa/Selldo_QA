...
public class ExportLeadsTest extends SetUp {

	final static Logger logger = Logger.getLogger(ExportLeadsTest.class);
	...
	public void exportLeadsTest() throws Exception {
		...
		test = extent.createTest("exportLeadsTest");
		setExtentTest(test);
		...
		getExtTest().log(Status.INFO, "Clicking on Export Leads tab.......");
		...
		getExtTest().log(Status.INFO, "Selecting Export type as Leads.......");
		...
		String leads = driver.findElements(exportPage.exportLabel).get(0).getAttribute("innerHTML");
		System.out.println(leads);

		getExtTest().log(Status.INFO, "Validating that the latest export is made for Leads.......");
