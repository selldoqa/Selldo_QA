...
public class ExportBookingsTest extends SetUp {
	...
	public void exportBookingsTest() throws Exception {
		...
		test = extent.createTest("exportBookingsTest");
		setExtentTest(test);
		...
		getExtTest().log(Status.INFO, "Clicking on Export Bookings tab.......");
		...
		getExtTest().log(Status.INFO, "Selecting Export type as Bookings......");
		...
		String booking = driver.findElements(exportPage.exportLabel).get(0).getAttribute("innerHTML");
		System.out.println(booking);

		getExtTest().log(Status.INFO, "Validating that the latest export is made for bookings.......");
		Assert.assertEquals(booking, "Booking Details - Export 1", "Not matched");
