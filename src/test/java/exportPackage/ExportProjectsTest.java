...
public class ExportProjectsTest extends SetUp {
	
	final static Logger logger = Logger.getLogger(ExportProjectsTest.class);
	...
	public void exportProjectsTest() throws Exception {
		...
		test = extent.createTest("exportProjectsTest");
		setExtentTest(test);
		...
		getExtTest().log(Status.INFO, "Clicking on Export Projects tab.......");
		...
		getExtTest().log(Status.INFO, "Selecting Export type as Project.......");
		...
		String Project = driver.findElements(exportPage.exportLabel).get(0).getAttribute("innerHTML");
		System.out.println(Project);

		getExtTest().log(Status.INFO, "Validating that the latest export is made for Projects.......");
