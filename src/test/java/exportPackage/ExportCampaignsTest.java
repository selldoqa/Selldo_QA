...
public class ExportCampaignsTest extends SetUp {

	final static Logger logger = Logger.getLogger(ExportCampaignsTest.class);
	...
	public void exportCampaignsTest() throws Exception {
		...
		test = extent.createTest("exportCampaignsTest");
		setExtentTest(test);
		...
		getExtTest().log(Status.INFO, "Clicking on Export Campaigns tab.......");
		...
		getExtTest().log(Status.INFO, "Selecting Export type as Campaigns.......");
		...
		String campaign = driver.findElements(exportPage.exportLabel).get(0).getAttribute("innerHTML");
		System.out.println(campaign);

		getExtTest().log(Status.INFO, "Validating that the latest export is made for Campaigns.......");
