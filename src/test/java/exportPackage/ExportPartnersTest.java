...
public class ExportPartnersTest extends SetUp {

	final static Logger logger = Logger.getLogger(ExportPartnersTest.class);
	...
	public void exportPartnetsTest() throws Exception {
		...
		test = extent.createTest("exportPartnersTest");
		setExtentTest(test);
		...
		getExtTest().log(Status.INFO, "Clicking on Export Partners tab.......");
		...
		getExtTest().log(Status.INFO, "Selecting Export type as Partners.......");
		...
		String partner = driver.findElements(exportPage.exportLabel).get(0).getAttribute("innerHTML");
		System.out.println(partner);

		getExtTest().log(Status.INFO, "Validating that the latest export is made for Partners.......");
