...
public class ExportFollowupsTest extends SetUp {
	...
	public void exportFollowupsTest() throws Exception {
		...
		test = extent.createTest("exportFollowupsTest");
		setExtentTest(test);
		...
		getExtTest().log(Status.INFO, "Clicking on Export Followups tab.......");
		...
		getExtTest().log(Status.INFO, "Selecting Export type as Followups.......");
		...
		String followup = driver.findElements(exportPage.exportLabel).get(0).getAttribute("innerHTML");
		System.out.println(followup);

		getExtTest().log(Status.INFO, "Validating that the latest export is made for Followups.......");
