...
public class ExportTasksTest extends SetUp {

	final static Logger logger = Logger.getLogger(ExportTasksTest.class);
	...
	public void exportTasksTest() throws Exception {
		...
		test = extent.createTest("exportTasksTest");
		setExtentTest(test);
		...
		getExtTest().log(Status.INFO, "Clicking on Export Tasks tab.......");
		...
		getExtTest().log(Status.INFO, "Selecting Export type as Tasks.......");
		...
		String Tasks = driver.findElements(exportPage.exportLabel).get(0).getAttribute("innerHTML");
		System.out.println(Tasks);

		getExtTest().log(Status.INFO, "Validating that the latest export is made for Tasks.......");
