...
public class LeadBooking_NonInventory_ConfirmedTest extends SetUp {
	...
	public void appLogin() throws Exception {
		...
		login.login(property.getProperty("name") + "+" + property.getProperty("user_email_nonInventory_ConfirmedTest"),
	...
	public void bookingALead_ConfirmedTest() throws Exception {
		...
		getExtTest().log(Status.INFO, "Selecting stage as Confirmed.......");
		...
		Assert.assertEquals(driver.findElement(By.xpath("//span[@class='badge badge-success']")).getText(), "confirmed",
				"Not matched");
