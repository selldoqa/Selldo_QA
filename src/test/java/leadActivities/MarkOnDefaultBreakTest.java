...
public class MarkOnDefaultBreakTest extends SetUp {

	final static Logger logger = Logger.getLogger(MarkOnDefaultBreakTest.class);

	// Description: Marking on break for client having default break type
	...
	public void appLogin() throws Exception {
		...
		login.login(property.getProperty("name") + "+" + property.getProperty("user_email_defaultMarkingOnBreakTest"),
	...
	public void markingOnBreakTest() throws Exception {
		...
		test = extent.createTest("Mark on break for default break type client");
		setExtentTest(test);
