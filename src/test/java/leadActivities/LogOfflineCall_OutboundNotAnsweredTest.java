...
public class LogOfflineCall_OutboundNotAnsweredTest extends SetUp {
	...
	public void logOfflineCall_OutboundNotAnsweredTest() throws Exception {
		...
		test = extent.createTest("LogOfflineCall_OutboundNotAnsweredTest");
		setExtentTest(test);
		...
		Assert.assertEquals(croppedDirectionText, "Outgoing   |   Offline   |   Not Ans", "text not matching");
