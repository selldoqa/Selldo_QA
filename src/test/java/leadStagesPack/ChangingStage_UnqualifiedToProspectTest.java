...
public class ChangingStage_UnqualifiedToProspectTest extends SetUp {

	final static Logger logger = Logger.getLogger(ChangingStage_UnqualifiedToProspectTest.class);


	// Description: Changing stage from Unqualified to Prospect
	...
	public void appLogin() throws Exception {
		...
		login.login(
				property.getProperty("name") + "+"
						+ property.getProperty("user_email_changingStage_UnqualifiedToProspectTest"),
	...
	public void changingStage_UnqualifiedToProspectTest() throws Exception {
		...
		test = extent.createTest("changingStage_UnqualifiedToProspectTest");
		setExtentTest(test);
		...
		getExtTest().log(Status.INFO, "Selecting Unqualified list......");
		salesPresalesDashboard.SelectList("Unqualified");

		getExtTest().log(Status.INFO, "Opening Lead Details page of a lead under Unqualified stage......");
		...
		getExtTest().log(Status.INFO, "Changing stage from Unqualified to Prospect.......");
		...
		getExtTest().log(Status.INFO, "Verifying stage changed from Unqualified to Prospect.......");
