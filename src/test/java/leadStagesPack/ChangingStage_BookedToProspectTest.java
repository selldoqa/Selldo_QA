...
public class ChangingStage_BookedToProspectTest extends SetUp {

	final static Logger logger = Logger.getLogger(ChangingStage_BookedToProspectTest.class);

	// Description: Changing stage from Booked to Booked to Prospect
	...
	public void appLogin() throws Exception {
		...
		login.login(
				property.getProperty("name") + "+"
						+ property.getProperty("user_email_changingStage_BookedToProspectTest"),
	...
	public void changingStage_BookedToProspectTest() throws Exception {
		...
		test = extent.createTest("changingStage_BookedToProspectTest");
		setExtentTest(test);
		...
		getExtTest().log(Status.INFO, "Selecting Booked list......");
		salesPresalesDashboard.SelectList("Booked");

		getExtTest().log(Status.INFO, "Opening Lead Details page of a lead under Booked stage......");
		...
		getExtTest().log(Status.INFO, "Changing stage from Booked to Prospect.......");
		...
		getExtTest().log(Status.INFO, "Verifying stage changed from Booked to Prospect.......");
