...
public class ChangingStage_ProspectToUnqualifiedTest extends SetUp {

	final static Logger logger = Logger.getLogger(ChangingStage_ProspectToUnqualifiedTest.class);

	// Description: Changing stage from Prospect to Unquaified
	...
	public void appLogin() throws Exception {
		...
		login.login(
				property.getProperty("name") + "+"
						+ property.getProperty("user_email_changingStage_ProspectToUnqualifiedTest"),
	...
	public void changingStage_ProspectToUnqualifiedTest() throws Exception {
		...
		test = extent.createTest("changingStage_ProspectToUnqualifiedTest");
		setExtentTest(test);
		...
		getExtTest().log(Status.INFO, "Changing stage from Prospect to Unqualified.......");

		leadProfilePage.changing_Stage("Unqualified");


		getExtTest().log(Status.INFO, "Selecting reason for Unqualified.......");
		...
		getExtTest().log(Status.INFO, "Verifying stage changed from Prospect to Unqualified.......");
