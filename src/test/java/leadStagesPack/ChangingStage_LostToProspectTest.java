...
public class ChangingStage_LostToProspectTest extends SetUp {

	final static Logger logger = Logger.getLogger(ChangingStage_LostToProspectTest.class);

	// Description: Changing stage from Lost to Prospect
	...
	public void appLogin() throws Exception {
		...
		login.login(
				property.getProperty("name") + "+"
						+ property.getProperty("user_email_changingStage_LostToProspectTest"),
	...
	public void changingStage_LostToProspectTest() throws Exception {
		...
		test = extent.createTest("changingStage_LostToProspectTest");
		setExtentTest(test);
		...
		getExtTest().log(Status.INFO, "Selecting Lost list......");
		salesPresalesDashboard.SelectList("Lost");

		getExtTest().log(Status.INFO, "Opening Lead Details page of a lead under Lost stage......");
		...
		getExtTest().log(Status.INFO, "Changing stage from Lost to Prospect.......");
		...
		getExtTest().log(Status.INFO, "Verifying stage changed from Lost to Prospect.......");
